...
toKnow=function(i){const r=A[i],k=document.getElementById('know');
 ...
 n.innerHTML='<p>Sounds like '+art(r[1])+' <b style="color:'+r[3]+'">'+r[1]+'</b>? Know for sure.</p><a class="btn" href="'+QUIZ+'">Take the Hidden Work Quiz <span>&rarr;</span></a>';};
