...
const questions = [
  ...
  { type: 'choice', section: 'X', unscored: true, routingFlag: true,
    ...
    options: [["No, nothing from my past is holding me back", "none"], ["Maybe, and I'm not sure what it is", "low"], ["Maybe, but I've mostly worked through it", "low"], ["Yes, and I still feel its effects", "moderate"], ["Yes, and I think it's the main thing keeping me stuck", "strong"]] },
...
// HWLP START: landing page as the quiz intro. Generated by _testing_now/gen_landing_embed.py; do not edit by hand.
var HWLP_HTML = "<div class=\"hwlp\"><svg width=\"0\" height=\"0\" style=\"position:absolute\" aria-hidden=\"true\">\n  <symbol id=\"i-HHH\" viewBox=\"0 0 24 24\"><path d=\"M12 2.5l6 7.5-3.5 10h-5L6 10z\"/><path d=\"M12 2.5V12\"/><circle cx=\"12\" cy=\"13.2\" r=\"1.3\"/><path d=\"M9.5 20h5v1.5h-5z\"/></symbol>\n  <symbol id=\"i-HHL\" viewBox=\"0 0 24 24\"><path d=\"M8 3.5h8v5.5a4 4 0 0 1-8 0z\"/><path d=\"M8 5.5H5.5a3 3 0 0 0 3 4.4\"/><path d=\"M16 5.5h2.5a3 3 0 0 1-3 4.4\"/><path d=\"M12 13v3.5\"/><path d=\"M9.5 16.5h5\"/><path d=\"M8 20.5h8\"/><path d=\"M9.5 16.5l-.8 4M14.5 16.5l.8 4\"/></symbol>\n  <symbol id=\"i-HLH\" viewBox=\"0 0 24 24\"><path d=\"M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12z\"/><circle cx=\"12\" cy=\"12\" r=\"3.2\"/><circle cx=\"12\" cy=\"12\" r=\".6\" fill=\"currentColor\"/></symbol>\n  <symbol id=\"i-HLL\" viewBox=\"0 0 24 24\"><circle cx=\"17\" cy=\"6.5\" r=\"2.3\"/><path d=\"M2.5 19l6-8.5 4 5 3-3.5 6 7\"/><path d=\"M2.5 19h19\"/><path d=\"M5 21.5h3M11 21.5h7\"/></symbol>\n  <symbol id=\"i-LHH\" viewBox=\"0 0 24 24\"><circle cx=\"12\" cy=\"12\" r=\"9\"/><path d=\"M15.8 8.2l-2.3 5.3-5.3 2.3 2.3-5.3z\"/><path d=\"M12 3v1.8M12 19.2V21M3 12h1.8M19.2 12H21\"/></symbol>\n  <symbol id=\"i-LHL\" viewBox=\"0 0 24 24\"><path d=\"M3.5 17a8.5 8.5 0 1 1 17 0\"/><path d=\"M12 17l4.2-5.2\"/><circle cx=\"12\" cy=\"17\" r=\"1.4\"/><path d=\"M6 12.5l1.2.8M12 8.5v1.5M18 12.5l-1.2.8\"/><path d=\"M3.5 20.5h17\"/></symbol>\n  <symbol id=\"i-LLH\" viewBox=\"0 0 24 24\"><path d=\"M12 14.5c-3.8 0-6.3-2.2-6.3-5.2 0-2.2 1.6-3.6 3.2-3.8.6-1.9 1.8-3 3.1-3s2.5 1.1 3.1 3c1.6.2 3.2 1.6 3.2 3.8 0 3-2.5 5.2-6.3 5.2z\"/><path d=\"M12 9v9.5\"/><path d=\"M12 12l-2.2-1.8M12 11l2.2-1.8\"/><path d=\"M4 18.5h16\"/><path d=\"M12 18.5l-3 2.8M12 18.5l3 2.8\"/></symbol>\n  <symbol id=\"i-LLL\" viewBox=\"0 0 24 24\"><path d=\"M12 21.5V12\"/><path d=\"M12 17.5c-3.2 0-4.8-2-4.8-4.3 2.4 0 4.8 1.4 4.8 4.3z\"/><path d=\"M12 12c-2.6 0-3.8-2.6-3.8-5.5 1.4.6 2.7 1.5 3.8 2.8 1.1-1.3 2.4-2.2 3.8-2.8 0 2.9-1.2 5.5-3.8 5.5z\"/><path d=\"M12 9.3V3.5\"/><path d=\"M4.5 21.5h15\"/></symbol>\n</svg>\n<nav class=\"topbar\"><span class=\"lg\" role=\"img\" aria-label=\"The Hidden Work Quiz\"><svg class=\"rg\" viewBox=\"0 0 34 34\" aria-hidden=\"true\"><circle cx=\"27.35\" cy=\"12.71\" r=\"4.90\" fill=\"#B23A2E\"/><circle cx=\"27.35\" cy=\"21.29\" r=\"3.00\" fill=\"#C2722F\"/><circle cx=\"21.29\" cy=\"27.35\" r=\"3.00\" fill=\"#B8902F\"/><circle cx=\"12.71\" cy=\"27.35\" r=\"3.00\" fill=\"#3D7A6E\"/><circle cx=\"6.65\" cy=\"21.29\" r=\"3.00\" fill=\"#1E5F8C\"/><circle cx=\"6.65\" cy=\"12.71\" r=\"3.00\" fill=\"#557C9E\"/><circle cx=\"12.71\" cy=\"6.65\" r=\"3.00\" fill=\"#6B6B6B\"/><circle cx=\"21.29\" cy=\"6.65\" r=\"3.00\" fill=\"#A85A3D\"/></svg><b class=\"nm\">H<b class=\"idot\">\u0131</b>dden Work</b><b class=\"q\">QUIZ</b></span><a class=\"btn\" href=\"#start\" data-hwlp-cta=\"other\">Discover my Work Personality <span>&rarr;</span></a></nav>\n<header class=\"c hero\">\n  <div class=\"glow\" aria-hidden=\"true\"></div>\n  <h1>You're good<br>at your job.<span class=\"q\">So why does it sometimes<br>feel like the wrong one?</span></h1>\n  <p class=\"sub\">In five minutes, discover why certain work drains you, what kind of work energizes you, and the quick wins you can make this week.</p>\n  <div><a class=\"btn\" id=\"heroCta\" href=\"#start\" data-hwlp-cta=\"hero\">Discover my Work Personality <span>&rarr;</span></a></div>\n  <a class=\"peek\" href=\"#pick\"><span class=\"ics\" id=\"peek\"></span><span>8 Work Personalities. Which one are you? &darr;</span></a>\n  <div class=\"chips\"><span><b>&check;</b>Free</span><span><b>&check;</b>Personalized Report</span><span><b>&check;</b>About 5 minutes</span><span><b>&check;</b>Your answers stay private</span></div>\n<p class=\"hq\"><q>&ldquo;I was rather floored when everything it said was accurate.&rdquo;</q><small>Lindsey O\u2019Neill &middot; Restless Explorer</small></p>\n</header>\n<section class=\"c lines\">\n  <p class=\"line\">You hit the numbers.</p>\n  <p class=\"line\">You get the praise.</p>\n  <p class=\"line\">People ask for you by name.</p>\n  <p class=\"line hot\">And Monday still feels heavy.</p>\n</section>\n<section class=\"c pick\" id=\"pick\">\n  <div class=\"lab\">8 Work Personalities</div>\n  <h2 class=\"h2\">Tap the one which sounds like you...</h2>\n  <div class=\"g\" id=\"g\"></div>\n  <div class=\"inl\" id=\"inl\" hidden aria-live=\"polite\"></div>\n</section>\n<section class=\"c get\"><div class=\"lab\">What You Get for Free</div><div class=\"get-grid\">\n    <div><svg class=\"gi\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><circle cx=\"12\" cy=\"8\" r=\"3.6\"/><path d=\"M4.5 20.5c1.2-4 4.2-6 7.5-6s6.3 2 7.5 6\"/></svg><b>Discover Your Work Personality</b><p>You are one of 8 patterns. Find out which one.</p></div>\n    <div><svg class=\"gi\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M3.5 17a8.5 8.5 0 1 1 17 0\"/><path d=\"M12 17l4.2-5.2\"/><circle cx=\"12\" cy=\"17\" r=\"1.4\"/></svg><b>Your Regret Signal</b><p>Are you on the right path?</p></div>\n    <div><svg class=\"gi\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><path d=\"M12 6.5c-2-1.6-5-2.2-8-1.8v13c3-.4 6 .2 8 1.8 2-1.6 5-2.2 8-1.8v-13c-3-.4-6 .2-8 1.8z\"/><path d=\"M12 6.5v13\"/></svg><b>Free Book Chapter</b><p>A free chapter from <i>Choose Your Work</i>, selected based on your work pattern.</p></div>\n    <div><svg class=\"gi\" viewBox=\"0 0 24 24\" aria-hidden=\"true\"><rect x=\"3.5\" y=\"3.5\" width=\"17\" height=\"17\" rx=\"3.5\"/><path d=\"M8 12.3l2.8 2.8L16.2 9\"/></svg><b>Practical Actions</b><p>One short email per day with an insight that helps you take action.</p></div>\n  </div><div class=\"midcta\"><a class=\"btn\" href=\"#start\" data-hwlp-cta=\"mid\">Discover my Work Personality <span>&rarr;</span></a></div></section>\n<section class=\"c more\"><!-- CONVERSION SLOT: 3 real reader quotes (Reader Messages DB, Promo OK). Never invent them. -->\n  <div class=\"lab\">From people who took it</div>\n    <div class=\"pqs\"><figure class=\"pq1\"><div><h3>&ldquo;Rather floored it was accurate&rdquo;</h3><blockquote>&ldquo;I\u2019ll admit that I wasn\u2019t sure this quiz would understand me, so I was rather floored when everything it said was accurate.&rdquo;</blockquote></div><figcaption><span class=\"av\">LO</span><span>Lindsey O\u2019Neill &middot; Restless Explorer</span></figcaption></figure><figure class=\"pq1\"><div><h3>&ldquo;Genuinely Insightful&rdquo;</h3><blockquote>&ldquo;It was genuinely insightful and subtly made me want to learn more&rdquo;</blockquote></div><figcaption><span class=\"av\">EC</span><span>Erin Cusack &middot; Late Bloomer</span></figcaption></figure><figure class=\"pq1\"><div><h3>&ldquo;Spot on&rdquo;</h3><blockquote>&ldquo;It feels spot on for where I\u2019m at in my career.&rdquo;</blockquote></div><figcaption><span class=\"av\">FB</span><span>Fiona Brauneisen &middot; Restless Visionary</span></figcaption></figure></div></section>\n<section class=\"c faq\">\n  <div class=\"lab\">Frequently Asked Questions</div>\n  <details><summary>Is it free?</summary><p>Yes. The quiz, your result, the chapter and the 7-day course are all free.</p></details>\n  <details><summary>How long does it take?</summary><p>About 5 minutes. There are 30 questions, and most take one tap.</p></details>\n  <details><summary>Who is it for?</summary><p>Anyone who works, at any stage: students, early, mid and late career, and people between roles.</p></details>\n  <details><summary>What happens when I finish?</summary><p>You enter your email and your Work Personality appears on screen. Your free chapter and the first of 7 daily emails follow by email.</p></details>\n  <details><summary>Why does it ask for my email?</summary><p>To send your result, your free chapter and the 7-day course. No spam. Unsubscribe anytime.</p></details>\n</section>\n<section class=\"final\" id=\"know\" aria-live=\"polite\"><div class=\"c\">\n  <p class=\"pre\" id=\"pre\"></p>\n  <p class=\"pq\" id=\"pq\"></p>\n  <h2>Know for<br><i>sure.</i></h2>\n  <a class=\"btn\" id=\"finalBtn\" href=\"#start\" data-hwlp-cta=\"closer\">Discover my Work Personality <span>&rarr;</span></a>\n  <div class=\"chips\"><span><b>&check;</b>Free</span><span><b>&check;</b>Personalized Report</span><span><b>&check;</b>About 5 minutes</span><span><b>&check;</b>Your answers stay private</span></div>\n</div></section>\n<div class=\"dbar\" id=\"dbar\" aria-hidden=\"true\"><b>The Hidden Work Quiz</b><a class=\"btn\" href=\"#start\" data-hwlp-cta=\"desktop_bar\" tabindex=\"-1\">Discover my Work Personality <span>&rarr;</span></a></div>\n<div class=\"mcta\" id=\"mcta\"><a class=\"btn\" href=\"#start\" data-hwlp-cta=\"mobile_bar\">Discover my Work Personality <span>&rarr;</span></a></div></div>";
var HWLP_FONTS = "https://fonts.googleapis.com/css2?family=Inter+Tight:wght@400;500;700;800;900&family=Newsreader:ital,opsz,wght@0,6..72,400;1,6..72,300;1,6..72,400&display=swap";
function hwlpIsLanding(){ return screen === 'intro' && !(_invite && ARCH[_invite.key]); }
function hwlpInit(){
 var root = document.querySelector('#page .hwlp'); if (!root) return;
 if (!document.getElementById('hwlp-fonts')) { var l = document.createElement('link'); l.id = 'hwlp-fonts'; l.rel = 'stylesheet'; l.href = HWLP_FONTS; document.head.appendChild(l); }
 window._hwlpPick = null;
 hwCap('landing_viewed', {});
 root.addEventListener('click', function(e){
  var c = e.target.closest ? e.target.closest('#g .card') : null;
  if (c) { var r = A[+c.getAttribute('data-i')]; if (r) { window._hwlpPick = r[1]; hwCap('landing_pick', { archetype: r[1] }); } }
  var a = e.target.closest ? e.target.closest('a[href="#start"]') : null;
  if (!a) return;
  e.preventDefault();
  hwCap('landing_cta_clicked', { cta: a.getAttribute('data-hwlp-cta') || (a.closest('#inl') ? 'picker' : 'other'), pick: window._hwlpPick });
  startQuiz('landing');
 });
...
const q=t=>'\u201c'+t+'\u201d';
const QUIZ="#start";
const art=n=>/^[AEIOU]/.test(n)?'an':'a';
function pickLine(i){const n=A[i][1];return '<p>Sounds like '+art(n)+' <b>'+n+'</b>? The quiz tells you for sure.</p><a class="btn" href="'+QUIZ+'">Discover my Work Personality <span>&rarr;</span></a>';}
...
lightUp('.line');
function toKnow(i,scroll){const r=A[i],k=document.getElementById('know'),pre=document.getElementById('pre');
 k.style.setProperty('--acc',r[3]);pre.innerHTML='Sounds like '+art(r[1])+' <b>'+r[1]+'</b>?';
 if(scroll){const y=k.getBoundingClientRect().top+scrollY-40;scrollTo({top:y,behavior:matchMedia('(prefers-reduced-motion: reduce)').matches?'auto':'smooth'});}}
function wire(box,sel,after){box.addEventListener('click',e=>{const b=e.target.closest(sel);if(!b)return;
 box.querySelectorAll(sel).forEach(x=>x.setAttribute('aria-pressed',x===b));after(+b.dataset.i);});}
const cardHTML=(r,i)=>'<button class="card" style="--l:'+r[3]+'" aria-pressed="false" data-i="'+i+'"><span class="ico">'+ic(r[0])+'</span><span><span class="quote">'+q(r[4])+'</span><span class="who">'+r[1]+'</span></span></button>';
const g=document.getElementById('g');
g.innerHTML=A.map((r,i)=>cardHTML(r,i).replace('</span></span></button>','</span><span class="go">See below &darr;</span></span></button>')).join('');
wire(g,'.card',i=>{const r=A[i];
 document.getElementById('pq').textContent=q(r[4]);
 const m=document.querySelector('#mcta .btn');if(m)m.innerHTML='Am I '+art(r[1])+' '+r[1]+'? <span>&rarr;</span>';
 toKnow(i,true);});
document.getElementById('peek').innerHTML=A.map(r=>'<svg class="ic" style="color:'+r[3]+'" aria-hidden="true"><use href="#i-'+r[0]+'"/></svg>').join('');
toKnow=function(i){const r=A[i],k=document.getElementById('know');
 k.style.setProperty('--acc',r[3]);document.getElementById('pre').innerHTML='Sounds like '+art(r[1])+' <b>'+r[1]+'</b>?';
 const n=document.getElementById('inl');n.hidden=false;
 n.innerHTML='<p>Sounds like '+art(r[1])+' <b style="color:'+r[3]+'">'+r[1]+'</b>? Know for sure.</p><a class="btn" href="'+QUIZ+'">Discover my Work Personality <span>&rarr;</span></a>';};
...
(function(){var t=toKnow;toKnow=function(i){t(i);var n=A[i][1],lab='Find out if I\u2019m '+art(n)+' '+n+' <span>&rarr;</span>';
 var a=document.querySelector('#inl .btn');if(a)a.innerHTML=lab;var f=document.getElementById('finalBtn');if(f)f.innerHTML=lab;};})();
...
function renderIntro() {
  if (hwlpIsLanding()) return HWLP_HTML;  // HWLP
...
const SHARE = {
  ...
  LHH: "I'm moving fast. I just need to clarify my direction.",
...
const NARR = {
  HHH: "As a True Creator, you are one of the rare ones. This is the result of deliberate choices that few people ever make.\n• You have discovered the work that you are meant to do.\n• You pursue this work, uninhibited by the subtle pressure applied by others.\n• Your work gives you energy, instead of draining you of energy.\nTHE RISK: At this altitude, comfort can shrink your ambition.\nTHE QUESTION: Now that you have found your work, how can you make it world-class? See the “Next Moves” section below for more.",
  HHL: "As a High Achiever, you seem very good at what you do, and you appear to know exactly what you are aiming at. Everyone can see your skill, drive, and results. The only problem seems to be that your goals are largely the product of other people's expectations, or of work that has stopped satisfying you.\n• Somewhere in the past, your ambitions may have been influenced by what others expected or admired.\n• You execute brilliantly against a target that looks impressive but may not have been chosen by your true self.\n• The more you have achieved, the more you have invested, which is exactly what makes changing direction so hard.\n• Since you appear successful, it can be hard to acknowledge there is a problem.\nTHE CHALLENGE: Winning the wrong game feels hollow after a while, even if no one else notices.\nTHE NEXT STEP: Name the work you would choose if no one was watching. Your drive and past accomplishments will serve you well the moment you begin this work. See the “Next Moves” section below for more.",
  HLH: "As an Awakened Observer, something seems to have shifted. You appear to have done the inner work most people put off, and you can see your real work clearly.\n• You know where you are going.\n• The noise of other people's expectations has gone quiet.\n• You make your own decisions.\nTHE CHALLENGE: You do not yet have a system. Clarity without action leads to drifting.\nTHE NEXT STEP: Reflection and insight have done their job. Now it is time to take action: start the 1-1-1 rule this week. Spend one hour a day, on one project, in one location. See the “Next Moves” section below for more.",
  HLL: "As a Restless Visionary, you know what your real work is, maybe you have known for many years. Despite this, you seem to be standing still, inside a life built around the expectations of others. What seems to hold you there:\n• The title, the salary, the status.\n• The weight of other people's expectations.\n• How much you have already invested.\nTHE CHALLENGE: Clarity alone is not enough. Knowing what to do is only half the journey.\nTHE NEXT STEP: Come up with at least three intensely emotional reasons to move forward. See the “Next Moves” section below for more.",
  LHH: "As a Restless Explorer, you seem to have energy and momentum. The good news is that you appear to have already mastered the hardest parts:\n• You are true to yourself.\n• You take action and do not wait around.\nTHE CHALLENGE: You are moving fast, but largely to escape from what you do not want. Now is the time to define a target that matters to you.\nTHE NEXT STEP: Pick one of the things you have been exploring and give it a clear target. The Next Moves below walk you through it.",
  LHL: "As a Tireless Driver, you have serious horsepower. You move fast, you push hard, and you are used to powering through resistance. The problem seems to be that grit dominates how you think.\n• You seem to be working hard at something chosen by your ambition and your training. Your true self may have had little say in it.\n• This may be why you sometimes feel drained.\nTHE CHALLENGE: You are skilled at getting things done but it's worth spending more time on why you are doing them so that they don't leave you feeling drained.\nTHE NEXT STEP: Name one task that drains you and one that energizes you. Then move 30 minutes of your week from the first to the second. See the “Next Moves” section below for more.",
  LLH: "As a Grounded Seeker, you seem to know who you are:\n• You are rarely influenced by other people's expectations.\n• You have thoughtfully created a life based on your own values.\n• What appears to be missing is specific action toward the work that you are meant to do.\nTHE RISK: Being at peace can become an excuse to stay put.\nTHE NEXT STEP: You have character but you are capable of taking more action. This week, try three things that pull you in, even if you don't know where they will lead. See the “Next Moves” section below for more.",
  LLL: "As a Late Bloomer, your life looks fine from the outside. Maybe even good. There is a paycheck, a routine, people who would call you successful. And yet there is a small, persistent pebble in your emotional shoe that you have been trying to ignore:\n• You do not seem to know what your real work is yet.\n• You appear unsure what to do next.\n• You do not feel like you have intentionally chosen the life that you are living.\nTHE RISK: You are suffering in comfort, and yet it feels easy to not change anything. You know something is off.\nTHE NEXT STEP: Write down what needs to change. Then take one small action this week that your old self would not take. See the “Next Moves” section below for more."
};
// The LHH closer ends by pointing at the Next Moves card below it. The email has no
// card below, so the pointer sentence is stripped from every Kit payload (Dan's ruling,
// 21 Aug 2026: "for email, remove this: The Next Moves below walk you through it.").
function hwEmailNarr(n){ return n.replace(' The Next Moves below walk you through it.', '').split(" See the \u201cNext Moves\u201d section below for more.").join(''); }
const WHY = {
...
function amFoothillsNarr(s){
  const base = "You seem clear about what matters, you're taking action, and your work looks reasonably aligned. That puts you in a good position. But there is still work to do.";
...
const AM_DRAINED_SHARE = "I'm building something that matters. It just isn't energizing me right now.";
const AM_DRAINED_WHY = "You've chosen your work. This chapter is about scaling it and making it world-class.";
const AM_DRAINED_NARR = "You've done the hard part. You've found work that matters to you and you're taking action. This is rare. But right now it's draining you more than it's energizing you. Even when you choose your work, it can start to feel off when the workload is not sustainable or there has been a subtle change in your values. This doesn't mean you're necessarily on the wrong path, but it is a sign that something needs to change. For one week, note the moments your energy drops. What they have in common is the thing that needs to change.";
...
const DS_HIGH_V_NARR = "You seem to know who you are. Your work energizes you. But that energy appears mostly spent on other work, while the things that really matter are left to wait.\nWith your drive and self-knowledge, you are likely to be very successful once you name your next move and give it one dedicated hour each week.";
...
const SENTENCES = {
  C: [
    ...
    "You appear to have chosen your work."
  ],
  AG: [
  ...
  AL: [
    ...
    "Your work appears to be chosen by you, not the expectation of others."
  ],
...
function regretMeta(v){
  ...
  if (v <= 25) return { label:'High',     idx:3, color:'#B23A2E', desc:"There is a major gap between where you are and the work you could be doing." };
  if (v <= 45) return { label:'Elevated', idx:2, color:'#C2722F', desc:"There is a major gap between where you are and the work you could be doing." };
  if (v <= 65) return { label:'Moderate', idx:1, color:'#B8902F', desc:"There is a gap between where you are and the work you could be doing." };
  return            { label:'Low',      idx:0, color:'#3D7A6E', desc:"You are in great shape across the board. Well done. Keep going." };
}
...
// A REFERRER link (an association newsletter, a directory listing, a podcast show note)
// carries ref with NO type, so parseInviteFromUrl() rejects the whole URL and the ref is
// lost. Read it separately here, and keep it OUT of _invite on purpose: "invited",
// "from_share" and landed_from_share all read _invite, and a visit from a partner is not
// a share from a friend. Same validation as the share path.
const PARTNER_REF_KEY = 'hw_ref';
function parsePartnerRef(){
  try {
    var r = (new URLSearchParams(location.search).get('ref') || '').slice(0, 48);
    return /^[A-Za-z0-9_-]{2,48}$/.test(r) ? r : null;
  } catch(e){ return null; }
}
var _partnerRef = parsePartnerRef();
if (_partnerRef){ try { sessionStorage.setItem(PARTNER_REF_KEY, _partnerRef); } catch(e){} }
else { try { _partnerRef = sessionStorage.getItem(PARTNER_REF_KEY) || null; } catch(e){ _partnerRef = null; } }
...
// The referral id for this visit, from a friend's share link or from a partner link.
// Registered as a super property so quiz_started and quiz_completed inherit it
// (single-page app + memory persistence keeps it in-session).
var _refId = (_invite && _invite.ref) || _partnerRef || null;
try { if (_refId && window.posthog && posthog.register) posthog.register({ referred_by: _refId }); } catch(e){}
...
const SHARE_BASE = 'https://dandobos.com/hidden-work-quiz/';
// Per-archetype share-preview stubs: /hidden-work-quiz/t/<slug> sets an archetype-specific
...
const SHARE_STRENGTHS = {
  HHH:[["Doing work that matters","I have chosen my work and it energizes me."],["Clarity and action are aligned","I know where I’m going and taking action daily."],["Becoming world-class","Building from good toward world-class."]],
  HHL:[["Relentless execution","Sets a target and delivers on it."],["Visible, proven skill","The talent and the results speak for themselves."],["Brave enough to choose again","Willing to question a win and aim for something even more important."]],
  HLH:[["Deep self-knowledge","Has done the inner work and knows who they are."],["A clear inner compass","Decides from their own truth, not noise from others."],["An honest read","The person others come to for clarity."]],
...
function wcCardHtml(r, drained){
  ...
  return '<div class="wc" id="wc-card"><div class="wc-bar"></div>'
    ...
    + '<div class="foot-live"><a class="wc-cta" href="#hw-book-cta" onclick="hwCardCtaDown(event)">Discover Your Work Personality</a><p class="wc-src">A free 5-minute career quiz for people who want more from their work<br>dandobos.com/hidden-work-quiz</p></div>'
    + '</div>';
}
  ...
  return '<div class="res-divider"></div>'
    ...
    + '<div class="panelbox">'
      ...
      + '<div class="seg-body" data-m="friend">'
        ...
        + '<label class="pb-privacy"><span class="pb-switch"><input type="checkbox" ' + (_shareShowResult ? 'checked' : '') + ' onchange="hwShareVisToggle(this)"><span class="pb-knob"></span></span>Show my result to the people I share with</label>'
...
var _shareForMeReady = false, _shareForMeAsked = false;
function hwApplySendFor(){
  if (!_shareForMeReady) return;
  var el = document.getElementById('pb-sendfor');
  if (el) el.hidden = false;
}
function hwShareForMeReady(){
  if (_shareForMeAsked) { hwApplySendFor(); return; }
  _shareForMeAsked = true;
  try {
    fetch(BETA_BACKEND + '/share-email', { method: 'GET' })
      .then(function(r){ return r.ok ? r.json() : null; })
      .then(function(j){
        // The answer can land before the panel is in the DOM, which is how the
        // option stayed hidden on the saved-result page (21 Sep 2026). Remember
        // it, and apply it again every time the panel is rebuilt.
        _shareForMeReady = !!(j && j.ready);
        hwApplySendFor();
      }).catch(function(){});
  } catch (e) {}
}
...
function hwPlainShareBase(){
  ...
  var base = m ? m[0].replace(/t\/[a-z-]+\/?$/, '') : 'https://dandobos.com/hidden-work-quiz/';
...
function viralSaveImage(){
  ...
  var fl=clone.querySelector('.foot-live'); if(fl) fl.outerHTML='<div class="foot-dl"><p class="dl-discover">Discover Your Work Personality</p><p class="dl-tag">A free 5-minute career quiz for people who want more from their work</p><span class="dl-url">dandobos.com/hidden-work-quiz</span></div>';
...
function viralSaveStory(){
  ...
  bot.innerHTML='<p style="font-size:30px;font-weight:600;margin:0 0 8px">Find Your Pattern</p><p style="font-size:26px;opacity:.85;margin:0;letter-spacing:.5px">dandobos.com/hidden-work-quiz</p>';
...
function hwChapterHtml(key, s, flag){
  ...
  return '<p class="res-section-label">This Chapter Will Provide Practical Guidance Specific to Your Situation</p>'
...
function hwArchetypeFields(key){
  ...
  return {
    ...
    hw_welcome_subject: WELCOME_SUBJ[key], hw_share: share, hw_narrative: hwEmailNarr(narrative),
...
const CHECKLISTS = {
  ...
  LHH: { items: [
    ...
    `Take the one that pulls you in the most. Write an easy target for it, one you would know you had hit.`,
  ...
  LLL: { items: [
    ...
    `Tell someone you trust the thing you're done ignoring, so it is no longer only in your head. Who will you speak to?`
  ] }
};
var _fmQuestions = [];
...
function startQuiz(src) { clearState(); _submitting=false; _submitted=false; _kitEmail=''; hwTimingStart(); hwCap('quiz_started', { total_questions: TOTAL_Q, entry: (src === 'landing' ? 'landing' : 'intro') }); screen = 'question'; qIdx = 0; render(); }
...
function hwFields(){
  ...
  return {
    ...
    hw_share: share,
    hw_narrative: hwEmailNarr(narrative),
    ...
    hw_drainer: act.drainer,
    hw_energiser: act.energiser
  };
}

// The two activities Day 5 talks about, from the three the reader named and rated.
// The scale has no neutral point (0/30 drain, 70/100 energize), so a field is left
// EMPTY rather than filled with a best guess: an empty hw_drainer means nothing they
// are praised for drains them, and Day 5 branches on exactly that (Dan, 13 Aug).
// Ties keep the first activity, which is the order the reader typed them in.
function hwActivities(){
  var out = { drainer: '', energiser: '' };
  try {
    var lo = null, hi = null;
    for (var i = 0; i < 3; i++){
      var name = String((activityNames && activityNames[i]) || '').trim();
      var score = (activityScores && activityScores[i]);
      if (!name || typeof score !== 'number') continue;
      if (lo === null || score < activityScores[lo]) lo = i;
      if (hi === null || score > activityScores[hi]) hi = i;
    }
    if (lo !== null && activityScores[lo] <= 30) out.drainer = String(activityNames[lo]).trim();
    if (hi !== null && activityScores[hi] >= 70) out.energiser = String(activityNames[hi]).trim();
  } catch(e){}
  return out;
}
