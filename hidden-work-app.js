...
function renderIntro() {
  return '<p class="intro-eyebrow">The Hidden Work</p>'
    + '<h1 class="intro-title">Discover the work you are meant to do</h1>'
    + '<p class="intro-desc">A 7-minute assessment that helps you identify your work patterns and clarify your next move.</p>'
...
function viralLink(r){ return SHARE_BASE + '?type=' + r.key; }
...
function startQuiz() { clearState(); _submitting=false; _submitted=false; _kitConfirmed=false; _kitEmail=''; screen = 'question'; qIdx = 0; render(); }
...
function advance() { if (qIdx < questions.length - 1) { qIdx++; render(); } else { screen='gate'; render(); } }
function goBack() { if (advancing) return; if (qIdx > 0) { qIdx--; render(); } }
