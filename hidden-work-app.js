...
const AM_DRAINED_NARR = "You've done the hard part. You've found work that matters to you and you're taking action. This is rare. But right now it's draining you more than it's energizing you. Even when you choose your work, it can start to feel off when the workload is not sustainable or there has been a subtle change in your values. This doesn't mean you're necessarily on the wrong path, but it is a sign that something needs to change. Observe what depletes your energy and use that as a guide to move forward.";
